...
Learn how you can use our default theme in your project in more detail [Theming page](/?path=/docs/introduction-theming--page).

## Localisation

For localisation usecases you can use `@lundium/locale` package. Detailed walk-through can be found on [Localisation page](/?path=/docs/introduction-localisation--page).
